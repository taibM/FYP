...
<body>
	...
	<!-- header section end -->
    <form method="POST"  action="vieweventupdate.php">

<table border="1">
            <tr>
                <td> ID event <input  type="number" name="id_event" ></td>
             </tr>
             <tr>
                <td> name <input  type="text" name="nom" ></td>
             </tr>
             <tr>
             ...
             <tr>
                <td>place  <input  type="text" name="lieu" ></td>
             </tr>
             <tr>
                <td><input class="btn btn-primary" type="submit" name="update" ></td>
             </tr>

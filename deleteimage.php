...
<tr>
    ...
    <td> <form method="POST" action="deleteimage.PHP" >         
            <input  class="btn btn-primary"   type ="submit"  name="Submit" value="Delete"  >
            <input     type ="hidden" name="id_image" value="<?PHP  echo $row ['id_image'] ?> " >
    </form>
</td>
<td> <a class="site-btn" href="updateimage.php?CIN=<?PHP  echo $row ['id_image'] ;?>"> Update <img src="img/icons/arrow-right-black.png" alt=""></a></td>
